; ModuleID = './proj2/Puzzle.bc'
source_filename = "./llvm-test-suite/SingleSource/Benchmarks/Stanford/Puzzle.c"
...
if.then:                                          ; preds = %for.body
  ...
  %6 = load i32, i32* %j.addr, align 4
  %call = call i32 @Fit(i32 noundef %5, i32 noundef %6)
...
if.then4:                                         ; preds = %if.then
  ...
  %call5 = call i32 @Place(i32 noundef %7, i32 noundef %8)
  store i32 %call5, i32* %k, align 4
  %9 = load i32, i32* %k, align 4
  %call6 = call i32 @Trial(i32 noundef %9)
...
if.else:                                          ; preds = %lor.lhs.false
  ...
  call void @Remove(i32 noundef %11, i32 noundef %12)
  br label %if.end
...
for.inc102:                                       ; preds = %for.body95
  ...
  br label %for.cond93, !llvm.loop !22
...
for.inc108:                                       ; preds = %for.end107
  ...
  br label %for.cond87, !llvm.loop !24
...
for.inc126:                                       ; preds = %for.body119
  ...
  br label %for.cond117, !llvm.loop !25
...
for.inc129:                                       ; preds = %for.end128
  ...
  br label %for.cond114, !llvm.loop !26
...
for.inc132:                                       ; preds = %for.end131
  ...
  br label %for.cond111, !llvm.loop !27
...
for.inc150:                                       ; preds = %for.body143
  ...
  br label %for.cond141, !llvm.loop !28
...
for.inc153:                                       ; preds = %for.end152
  ...
  br label %for.cond138, !llvm.loop !29
...
for.inc174:                                       ; preds = %for.body167
  ...
  br label %for.cond165, !llvm.loop !31
...
for.inc177:                                       ; preds = %for.end176
  ...
  br label %for.cond162, !llvm.loop !32
...
for.inc180:                                       ; preds = %for.end179
  ...
  br label %for.cond159, !llvm.loop !33
...
for.inc201:                                       ; preds = %for.end200
  ...
  br label %for.cond186, !llvm.loop !35
...
for.inc204:                                       ; preds = %for.end203
  ...
  br label %for.cond183, !llvm.loop !36
...
for.inc222:                                       ; preds = %for.body215
  ...
  br label %for.cond213, !llvm.loop !37
...
for.inc225:                                       ; preds = %for.end224
  ...
  br label %for.cond210, !llvm.loop !38
...
for.inc228:                                       ; preds = %for.end227
  ...
  br label %for.cond207, !llvm.loop !39
...
for.inc252:                                       ; preds = %for.end251
  ...
  br label %for.cond231, !llvm.loop !42
...
for.inc270:                                       ; preds = %for.body263
  ...
  br label %for.cond261, !llvm.loop !43
...
for.inc273:                                       ; preds = %for.end272
  ...
  br label %for.cond258, !llvm.loop !44
...
for.inc276:                                       ; preds = %for.end275
  ...
  br label %for.cond255, !llvm.loop !45
...
for.inc294:                                       ; preds = %for.body287
  ...
  br label %for.cond285, !llvm.loop !46
...
for.inc297:                                       ; preds = %for.end296
  ...
  br label %for.cond282, !llvm.loop !47
...
for.inc300:                                       ; preds = %for.end299
  ...
  br label %for.cond279, !llvm.loop !48
...
for.inc318:                                       ; preds = %for.body311
  ...
  br label %for.cond309, !llvm.loop !49
...
for.inc321:                                       ; preds = %for.end320
  ...
  br label %for.cond306, !llvm.loop !50
...
for.inc324:                                       ; preds = %for.end323
  ...
  br label %for.cond303, !llvm.loop !51
...
for.inc342:                                       ; preds = %for.body335
  ...
  br label %for.cond333, !llvm.loop !52
...
for.inc345:                                       ; preds = %for.end344
  ...
  br label %for.cond330, !llvm.loop !53
...
for.inc348:                                       ; preds = %for.end347
  ...
  br label %for.cond327, !llvm.loop !54
...
for.end350:                                       ; preds = %for.cond327
  ...
  %call = call i32 @Fit(i32 noundef 0, i32 noundef %135)
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %for.end350
  %136 = load i32, i32* %m, align 4
  %call351 = call i32 @Place(i32 noundef 0, i32 noundef %136)
  store i32 %call351, i32* @n, align 4
  br label %if.end

if.else:                                          ; preds = %for.end350
  %call352 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0))
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %137 = load i32, i32* @n, align 4
  %call353 = call i32 @Trial(i32 noundef %137)
  %tobool354 = icmp ne i32 %call353, 0
  br i1 %tobool354, label %if.else357, label %if.then355

if.then355:                                       ; preds = %if.end
  %call356 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end362
...
if.then359:                                       ; preds = %if.else357
  %call360 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0))
  br label %if.end361
...
if.end362:                                        ; preds = %if.end361, %if.then355
  ...
  %call363 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 noundef %139)
  %140 = load i32, i32* @kount, align 4
  %call364 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 noundef %140)
  ret void
}
