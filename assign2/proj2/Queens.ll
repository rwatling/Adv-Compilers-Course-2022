; ModuleID = './proj2/Queens.bc'
source_filename = "./llvm-test-suite/SingleSource/Benchmarks/Stanford/Queens.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Try(i32 noundef %i, i32* noundef %q, i32* noundef %a, i32* noundef %b, i32* noundef %c, i32* noundef %x) #0 {
entry:
...
if.then23:                                        ; preds = %if.then
  ...
  call void @Try(i32 noundef %add24, i32* noundef %31, i32* noundef %32, i32* noundef %33, i32* noundef %34, i32* noundef %35)
...
while.end:                                        ; preds = %while.cond
  %arraydecay = getelementptr inbounds [17 x i32], [17 x i32]* %b, i64 0, i64 0
  %arraydecay14 = getelementptr inbounds [9 x i32], [9 x i32]* %a, i64 0, i64 0
  %arraydecay15 = getelementptr inbounds [15 x i32], [15 x i32]* %c, i64 0, i64 0
  %arraydecay16 = getelementptr inbounds [9 x i32], [9 x i32]* %x, i64 0, i64 0
  call void @Try(i32 noundef 1, i32* noundef %q, i32* noundef %arraydecay, i32* noundef %arraydecay14, i32* noundef %arraydecay15, i32* noundef %arraydecay16)
...
for.end:                                          ; preds = %for.cond
  ...
  %add = add nsw i32 %2, 1
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 noundef %add)
  ret void
}
