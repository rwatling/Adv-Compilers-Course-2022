; ModuleID = './proj2/Treesort.bc'
source_filename = "./llvm-test-suite/SingleSource/Benchmarks/Stanford/Treesort.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @CreateNode(%struct.node** noundef %t, i32 noundef %n) #0 {
entry:
  %t.addr = alloca %struct.node**, align 8
  %n.addr = alloca i32, align 4
  store %struct.node** %t, %struct.node*** %t.addr, align 8
  store i32 %n, i32* %n.addr, align 4
  %call = call noalias i8* @malloc(i64 noundef 24) #3
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Insert(i32 noundef %n, %struct.node* noundef %t) #0 {
entry:
  %n.addr = alloca i32, align 4
  %t.addr = alloca %struct.node*, align 8
  store i32 %n, i32* %n.addr, align 4
...
if.then2:                                         ; preds = %if.then
  ...
  %6 = load i32, i32* %n.addr, align 4
  call void @CreateNode(%struct.node** noundef %left3, i32 noundef %6)
  br label %if.end
...
if.else:                                          ; preds = %if.then
  ...
  call void @Insert(i32 noundef %7, %struct.node* noundef %9)
  br label %if.end
...
if.then10:                                        ; preds = %if.then8
  ...
  call void @CreateNode(%struct.node** noundef %right11, i32 noundef %16)
  br label %if.end14
...
if.else12:                                        ; preds = %if.then8
  ...
  call void @Insert(i32 noundef %17, %struct.node* noundef %19)
  br label %if.end14
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @Checktree(%struct.node* noundef %p) #0 {
entry:
...
if.else:                                          ; preds = %if.then
  ...
  %call = call i32 @Checktree(%struct.node* noundef %8)
...
if.else15:                                        ; preds = %if.then9
  ...
  %call17 = call i32 @Checktree(%struct.node* noundef %19)
...
for.body:                                         ; preds = %for.cond
  ...
  call void @Insert(i32 noundef %7, %struct.node* noundef %8)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 noundef %11)
  %12 = load %struct.node*, %struct.node** @tree, align 8
  %call4 = call i32 @Checktree(%struct.node* noundef %12)
  %tobool = icmp ne i32 %call4, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %for.end
  %call5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end
