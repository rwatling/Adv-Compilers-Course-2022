...
extern bool LVNEnabled;
extern bool SVNEnabled;
...
struct GVNOptions {
  ...
  // SVN and LVN Options
  Optional<bool> AllowSVNOnly = None;
  Optional<bool> AllowLVNOnly = None;
  ...
  // Enables or disables use of SVN
  GVNOptions &setSVNOnly(bool SVN) {
    AllowSVNOnly = SVN;
    return *this;
  }

  // Enables or disables use of LVN
  GVNOptions &setLVNOnly(bool LVN) {
    AllowLVNOnly = LVN;
    return *this;
  }
...
public:
  ...
  bool isGVNSVNOnlyEnabled() const;
  bool isGVNLVNOnlyEnabled() const;
